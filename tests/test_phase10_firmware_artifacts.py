...
PHASE10 = ROOT / "firmware" / "phase10_frozen"
ARTIFACTS = PHASE10 / "artifacts"


class TestPhase10FirmwareArtifacts(unittest.TestCase):
    ...
    def test_combined_image_contains_only_components_and_ff_gaps(self):
    ...
    def test_phase9_historical_artifacts_remain_unchanged(self):
        old = ROOT / "firmware" / "phase9_frozen" / "artifacts"
        self.assertEqual(
            hashlib.sha256((old / "micropython.bin").read_bytes()).hexdigest(),
