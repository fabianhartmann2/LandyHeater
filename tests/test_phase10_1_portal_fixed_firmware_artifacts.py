...
PHASE10_1_PORTAL_FIXED = (
    ROOT / "firmware" / "phase10_1_portal_fixed_frozen"
)
ARTIFACTS = PHASE10_1_PORTAL_FIXED / "artifacts"


class TestPhase101PortalFixedFirmwareArtifacts(unittest.TestCase):
    ...
    def test_combined_image_stops_before_vfs(self):
        ...
        self.assertEqual(len(application), 2_058_368)
