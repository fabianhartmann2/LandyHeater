...
PHASE10_1_FIXED = ROOT / "firmware" / "phase10_1_fixed_frozen"
ARTIFACTS = PHASE10_1_FIXED / "artifacts"


class TestPhase101FixedFirmwareArtifacts(unittest.TestCase):
    ...
    def test_combined_image_stops_before_vfs(self):
        ...
        self.assertEqual(len(application), 2_058_400)
