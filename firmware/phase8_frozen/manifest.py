"""Frozen Phase-8 product modules for MicroPython ESP32_GENERIC v1.28.0.

This manifest intentionally excludes boot.py, main.py, board_config.py,
credentials, persistent configuration, tests, and diagnostic smoke tools.
"""
